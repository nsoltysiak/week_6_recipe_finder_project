...
const vegButton = document.getElementById("dietary-vegetarian");
const veganButton = document.getElementById("dietary-vegan");
const glutenButton = document.getElementById("dietary-gluten-free");
const dairyButton = document.getElementById("dietary-dairy-free");
const ketoButton = document.getElementById("dietary-keto");
const paleoButton = document.getElementById("dietary-paleo");
...
italianButton.addEventListener("click", () => {
  setActiveCuisine("italian");
  getRecipesByCuisine("italian");
});

mexicanButton.addEventListener("click", () => {
  setActiveCuisine("mexican");
  getRecipesByCuisine("mexican");
});
asianButton.addEventListener("click", () => {
  setActiveCuisine("asian");
  getRecipesByCuisine("asian");
});
americanButton.addEventListener("click", () => {
  setActiveCuisine("american");
  getRecipesByCuisine("american");
});
indianButton.addEventListener("click", () => {
  setActiveCuisine("indian");
  getRecipesByCuisine("indian");
});
mediterraneanButton.addEventListener("click", () => {
  setActiveCuisine("mediterranean");
  getRecipesByCuisine("mediterranean");
});
...
vegButton.addEventListener("click", () => {
  setActiveDietary("vegetarian");
  getRecipesByDietary("vegetarian");
});

veganButton.addEventListener("click", () => {
  setActiveDietary("vegan");
  getRecipesByDietary("vegan");
});
glutenButton.addEventListener("click", () => {
  setActiveDietary("gluten-free");
  getRecipesByDietary("gluten free");
});
dairyButton.addEventListener("click", () => {
  setActiveDietary("dairy-free");
  getRecipesByDietary("dairy free");
});
ketoButton.addEventListener("click", () => {
  setActiveDietary("keto");
  getRecipesByDietary("ketogenic");
});
paleoButton.addEventListener("click", () => {
  setActiveDietary("paleo");
  getRecipesByDietary("Paleo");
});
...
function displayRecipesByCuisine(results) {
  const recipeResultsSection = document.querySelector(".recipe-results");
  recipeResultsSection.innerHTML = "";
  const recipesCount = document.getElementById("recipesFoundCount");
  recipesCount.innerHTML = results.length;
...
async function getRecipesByDietary(dietaryChoice) {
  const dietarySelection = dietaryChoice;

  const baseUrl = `https://api.spoonacular.com/recipes/complexSearch`;

  const searchParam = new URLSearchParams({
    diet: dietarySelection,
    addRecipeInformation: true,
    addRecipeNutrition: true,
    number: 12,
    apiKey: userApiKey,
...
function displayRecipesByDietary(results) {
  const recipeResultsSection = document.querySelector(".recipe-results");
  recipeResultsSection.innerHTML = "";
  const recipesCount = document.getElementById("recipesFoundCount");
  recipesCount.innerHTML = results.length;
